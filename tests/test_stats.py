...
def element_grid():
    return [
        ...
        ("water", 5, "mars ♋ , saturn ♋ , uranus ♏ , north_node ♏ , mc ♋ "),
        ("air", 2, "pluto ♎ , asc ♎ "),
    ]
...
def modality_grid():
    return [
        ("modality", "sum", "bodies"),
        ("fixed", 5, "sun ♉ , mercury ♉ , jupiter ♉ , uranus ♏ , north_node ♏ "),
...
def polarity_grid():
    return [
        ("polarity", "sum", "bodies"),
        ("negative", 9, "sun ♉ , moon ♑ , mercury ♉ , mars ♋ , jupiter ♉ , saturn ♋ , uranus ♏ , north_node ♏ , mc ♋ ",),
...
def quadrant_grid():
    return [
        ("quadrant", "sum", "bodies"),
        ("1st", 4, "moon, uranus, neptune, north_node"),
        ("2nd", 1, "venus"),
...
def hemisphere_grid():
    return [
        ...
        ("Eastern", 6, "moon, uranus, neptune, north_node, saturn, pluto"),
        ("Western", 5, "venus, sun, mercury, mars, jupiter"),
        ("Northern", 6, "sun, mercury, mars, jupiter, saturn, pluto"),
        ("Southern", 5, "moon, uranus, neptune, north_node, venus"),
    ]
...
def composite_aspect_grid():
    return [
        ...
        ("moon","⚹","mars","→ ←","0° 08'"),
        ("moon","□","neptune","← →","2° 08'"),
        ("moon","⚹","north_node","← →","2° 21'"),
        ("moon","⚹","mc","→ ←","4° 50'"),
        ("mercury","□","venus","→ ←","2° 25'"),
        ("mercury","☍","mars","→ ←","3° 30'"),
        ("mercury","□","pluto","← →","2° 38'"),
        ("mercury","⚹","north_node","→ ←","1° 00'"),
        ("venus","△","venus","→ ←","1° 33'"),
        ("venus","☌","neptune","← →","2° 44'"),
        ("venus","⚹","asc","→ ←","4° 11'"),
        ("mars","□","sun","→ ←","5° 06'"),
        ...
        ("pluto","□","pluto","→ ←","3° 41'"),
        ("north_node","△","sun","→ ←","0° 42'"),
        ("north_node","△","jupiter","← →","4° 44'"),
        ("north_node","⚹","uranus","← →","4° 11'"),
        ("asc","⚹","sun","← →","0° 02'"),
        ("asc","△","uranus","→ ←","4° 54'"),
        ("mc","△","venus","← →","5° 56'"),
        ("mc","☌","neptune","→ ←","4° 44'"),
