...
def test_composite_aspect_grid(composite_stats, composite_aspect_grid):
    head = composite_stats.composite_aspect_grid.split("\n")[:11]
    assert "\n".join(head) == composite_aspect_grid


def test_composite_aspects(composite_stats, composite_aspects):
    head = composite_stats.composite_aspect_table.split("\n")[:15]
    assert "\n".join(head) == composite_aspects
