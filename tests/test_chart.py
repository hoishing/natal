...
@fixture
def adj_outer_degs():
    return [0, 14, 22, 53, 89, 174, 184, 191, 198, 208, 263, 270, 277, 349]


@fixture
def adj_inner_degs():
    return [7, 23, 32, 195, 226, 277, 286, 297, 306, 315, 327, 337, 349, 358]
...
def test_adjusted_degrees(chart, adj_outer_degs):
